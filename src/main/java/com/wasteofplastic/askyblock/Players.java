...
public class Players {
    ...
    /**
     * @param uuid Constructor - initializes the state variables
     */
    ...
    /**
     * @param member Adds a member to the the player's list
     * @return
     */
    ...
    /**
     * @param l a Bukkit Location of the team island
     */
    ...
    /**
     * @param s a String name of the player
     */
     ...
     *
     * @param leader - a String of the leader's name
     * @param l - the Bukkit location of the team's island (converted to a
    ...
    /**
     * @param leader a String name of the team leader
     */
