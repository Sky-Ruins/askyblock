...
public class NetherPortals implements Listener {
    ...
    public void onEntityPortal(EntityPortalEvent event) {
        ...
        if (!Settings.createNether || ASkyBlock.getNetherWorld() == null) {
            if (DEBUG) {
                plugin.getLogger().info("DEBUG: Disabled nether: Settings create nether = " + Settings.createNether + " " + (
                        ASkyBlock.getNetherWorld() == null ? "Nether world is null" : "Nether world is not null"));
            }
            return;
        }
