...
public class SafeBoat implements Listener {
    ...
    /**
     * @param e This event check throws the boat at a player when they hit it
    ...
    /**
     * @param e This function prevents boats from exploding when they hit
     * something
     */
    ...
    /**
     * @param e This event aims to put the player in a safe place when they
     * exit the boat
     */
    @EventHandler(priority = EventPriority.NORMAL, ignoreCancelled = true)
